              ...
              .ConfigureWebHostDefaults(webBuilder =>
              {
                 webBuilder.ConfigureAppConfiguration(az => {
                    ...
                    az.AddAzureAppConfiguration(x=>
                                                {
                                                   //Allow managed identity to access app configuration and KV when deployed
                                                   var cred = new DefaultAzureCredential();

                                                   x.Connect(new Uri("https://chyaappconfig.azconfig.io"), cred);
                                                   ...
                                                   x.ConfigureKeyVault(kv => { kv.SetCredential(cred); });
                    });
                 });
